...
function StarMonsterMark({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 120 120" aria-hidden="true" className={className}>
      ...
      />
      <path d="M35 22 27 5 45 16" fill="#E01414" stroke="#0B0B0C" strokeWidth="5" strokeLinejoin="round" />
      <path d="M81 16 99 5 91 22" fill="#E01414" stroke="#0B0B0C" strokeWidth="5" strokeLinejoin="round" />
      <circle cx="43" cy="57" r="5" fill="#0B0B0C" />
      <circle cx="78" cy="57" r="5" fill="#0B0B0C" />
      <path d="m51 78 18-18M69 78 51 60" stroke="#0B0B0C" strokeWidth="5" strokeLinecap="round" />
      <path d="M13 66c-12 0-18-18-4-25 10-5 18 5 20 14" fill="#F7EFF6" stroke="#0B0B0C" strokeWidth="4" />
      <path d="M107 66c12 0 18-18 4-25-10-5-18 5-20 14" fill="#F7EFF6" stroke="#0B0B0C" strokeWidth="4" />
    </svg>
  );
}
